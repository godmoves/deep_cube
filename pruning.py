...
# global variables, initialized during pruning table cration
flipslice_twist_depth3 = None
                ...
                while twist < defs.N_TWIST:
                    ...
                    if match:
                        ...
                        for m in enums.Move:
                            ...
                            # defs.N_PERM_4 = 24, 18*24 = 432
                            slice1 = mv.slice_sorted_move[432 *
                                                          slice_ + m] // 24
                ...
                while ud_edge < defs.N_UD_EDGES:
                    ...
                    if get_corners_ud_edges_depth3(idx) == depth3:
                        ...
                        for m in (enums.Move.U1, enums.Move.U2, enums.Move.U3, enums.Move.R2, enums.Move.F2,
                            ...
                            ud_edge1 = sy.ud_edges_conj[(
                                ud_edge1 << 4) + c1_sym]
                            idx1 = 40320 * c1_classidx + ud_edge1  # N_UD_EDGES = 40320
                            # entry not yet filled
                            if get_corners_ud_edges_depth3(idx1) == 3:
...
def create_phase2_cornsliceprun_table():
    ...
    fname = "data/phase2_cornsliceprun"
    global cornslice_depth
    if not path.isfile(fname):
        print("creating " + fname + " table...")
        cornslice_depth = ar.array(
            'b', [-1] * (defs.N_CORNERS * defs.N_PERM_4))
